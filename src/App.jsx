...
const TEAM_MEMBERS = [
  {
    ...
    image: "src/image/profile 1.jpeg",
  },
  {
    name: "Anupa Singh",
...
const FloatingActionMenu = ({onOpenQuery, isDarkMode}) => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end space-y-3 pointer-events-none">
      ...
      <div
        className={`transition-all duration-300 ease-in-out flex flex-col items-end space-y-3 ${isOpen ? "opacity-100 translate-y-0 scale-100 pointer-events-auto" : "opacity-0 translate-y-10 scale-90 pointer-events-none"}`}
      >
        {/* 1. Ask Queries */}
        <button
          onClick={() => {
        ...
        >
          ...
          <div
            className={`${iconBase} text-orange-500 hover:bg-orange-50 ${isDarkMode ? "hover:bg-gray-700" : ""}`}
          >
            <Info size={20} />
          </div>
        </button>
        ...
        >
          ...
          <div
            className={`${iconBase} text-green-500 hover:bg-green-50 ${isDarkMode ? "hover:bg-gray-700" : ""}`}
          >
        ...
        >
          ...
          <div
            className={`${iconBase} text-blue-500 hover:bg-blue-50 ${isDarkMode ? "hover:bg-gray-700" : ""}`}
          >
            <MapPin size={20} />
          </div>
        </a>
        ...
        <a href={`tel:${config.phone}`} className={btnBase}>
          ...
          <div
            className={`${iconBase} text-red-500 hover:bg-red-50 ${isDarkMode ? "hover:bg-gray-700" : ""}`}
          >
            <Phone size={20} />
          </div>
        </a>
...
const QueryModal = ({
  ...
  return (
    ...
    >
      <div
        className={`rounded-2xl w-full max-w-md overflow-hidden shadow-2xl animate-fade-in-up ${isDarkMode ? "bg-[#2A2A2A] text-white" : "bg-white"}`}
...
const InstallBanner = ({onInstall, onClose, isVisible}) => {
  ...
  return (
    <div
      className={`hidden md:flex fixed bottom-6 right-6 z-[60] animate-fade-in-up`}
    >
      <button
        onClick={onInstall}
...
const SkeletonCard = ({isDarkMode}) => (
  <div
    className={`${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-gray-100 border-gray-200"} p-6 rounded-2xl shadow-sm border h-full flex flex-col animate-pulse`}
  >
    <div
      className={`w-14 h-14 ${isDarkMode ? "bg-gray-700" : "bg-gray-300"} rounded-full mb-4`}
    ></div>
    <div
      className={`h-6 ${isDarkMode ? "bg-gray-700" : "bg-gray-300"} rounded w-3/4 mb-2`}
    ></div>
    <div
      className={`h-4 ${isDarkMode ? "bg-gray-700" : "bg-gray-300"} rounded w-full mb-2`}
    ></div>
    <div
      className={`h-4 ${isDarkMode ? "bg-gray-700" : "bg-gray-300"} rounded w-5/6 mb-3`}
    ></div>
    <div className="mt-auto pt-2 flex justify-between items-center">
      <div
        className={`h-5 ${isDarkMode ? "bg-gray-700" : "bg-gray-300"} rounded w-16`}
      ></div>
      <div
        className={`h-4 ${isDarkMode ? "bg-gray-700" : "bg-gray-300"} rounded w-12`}
      ></div>
    </div>
  </div>
);
...
const SkeletonImage = ({isDarkMode}) => (
  <div
    className={`aspect-square ${isDarkMode ? "bg-gray-800" : "bg-gray-200"} rounded-2xl animate-pulse w-full h-full relative overflow-hidden`}
  >
    <div
      className={`absolute inset-0 bg-gradient-to-r ${isDarkMode ? "from-gray-800 via-gray-700 to-gray-800" : "from-gray-200 via-gray-100 to-gray-200"} animate-[shimmer_1.5s_infinite]`}
    ></div>
  </div>
);
...
const BookingModal = ({isOpen, onClose, services, isDarkMode}) => {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(
      `https://wa.me/916207413198?text=${encodeURIComponent(text)}`,
      "_blank",
    );
    onClose();
  };
    ...
    >
      ...
      >
        ...
        <form className="p-6 space-y-4" onSubmit={handleSubmit}>
          <div>
            <label
              className={`block text-sm font-bold mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}
            >
              Your Name
            </label>
            <input
...
const ServiceCard = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`w-14 h-14 rounded-full flex items-center justify-center mb-4 group-hover:bg-white transition-colors duration-300 shrink-0 ${isDarkMode ? "bg-gray-700" : "bg-[#F2F7F6]"}`}
      >
        <Icon
      ...
      <h3
        className={`text-xl font-serif font-bold mb-2 group-hover:text-white transition-colors ${isDarkMode ? "text-white" : "text-[#3D3D3D]"}`}
      >
        {title}
      </h3>
      <p
        className={`text-sm mb-3 flex-grow group-hover:text-white/90 transition-colors line-clamp-3 ${isDarkMode ? "text-gray-300" : "text-gray-500"}`}
      >
        {description}
      </p>
...
const HomeView = ({
  ...
  return (
    <>
      <section className="relative pt-24 pb-16 md:pt-40 md:pb-32 px-6 overflow-hidden">
        ...
        <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div className="space-y-6 animate-fade-in-up order-2 md:order-1 text-center md:text-left">
            ...
            <h1
              className={`text-4xl md:text-5xl lg:text-6xl font-serif font-bold leading-tight ${isDarkMode ? "text-white" : "text-[#3D3D3D]"}`}
            >
              Reveal Your Inner{" "}
              <span className="text-[var(--theme-primary)]">Glow</span> & Beauty
            </h1>
            <p
              className={`text-sm leading-relaxed md:text-lg md:leading-normal max-w-[90%] md:max-w-lg mx-auto md:mx-0 ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}
            >
          ...
          <div className="relative flex justify-center order-1 md:order-2">
            <div className="relative">
              ...
              <div
                className={`w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-full border-[8px] md:border-[12px] shadow-2xl overflow-hidden relative flex items-center justify-center z-10 ${isDarkMode ? "border-gray-800 bg-gray-800" : "border-white bg-[#F9F7F2]"}`}
              >
                <img
                  src={mainLogo}
                  alt="Radiance Logo"
            ...
            <div
              className={`absolute -bottom-4 right-10 md:right-auto md:-left-4  p-1.5 md:p-3 scale-85 md:scale-100 rounded-xl shadow-lg flex items-center gap-3 animate-bounce-slow max-w-[150px] z-20 ${isDarkMode ? "bg-[#2A2A2A]" : "bg-white"}`}
            >
              ...
              <div className="text-left scale-90 md:scale-100">
                <p
                  className={`font-bold text-sm ${isDarkMode ? "text-white" : "text-[#3D3D3D]"}`}
                >
                  4.9 Rating
                </p>
      ...
      >
        <div className="container mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-10">
            <h2
              className={`text-3xl md:text-4xl font-serif font-bold mb-4 ${isDarkMode ? "text-white" : "text-[#3D3D3D]"}`}
            >
              Our Services
            </h2>
            ...
            {isLoading ? (
              ...
              displayedServices.map((s) => (
                <ServiceCard
                  key={s.id}
                  {...s}
                  onClick={() => handleNav("gallery", null, s.id)}
      ...
      <section
        className={`py-16 md:py-20 ${isDarkMode ? "bg-[#121212]" : "bg-[#FDFBF7]"}`}
      >
        <div className="container mx-auto px-6">
          <div className="text-center mb-12 md:mb-16">
            <h2
              className={`text-3xl font-serif font-bold ${isDarkMode ? "text-white" : "text-[#3D3D3D]"}`}
            >
              Meet Our Experts
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
            {dynamicTeam.map((member, i) => (
              <div
                key={i}
                className={`p-6 rounded-2xl shadow-lg flex flex-col sm:flex-row items-center sm:items-start gap-6 border hover:shadow-xl transition-shadow text-center sm:text-left ${isDarkMode ? "bg-[#2A2A2A] border-gray-700" : "bg-white border-gray-100"}`}
              >
                ...
                <div>
                  <h3
                    className={`text-xl font-bold ${isDarkMode ? "text-white" : "text-[#3D3D3D]"}`}
                  >
                    {member.name}
                  </h3>
                  ...
                  <p
                    className={`text-sm mt-2 flex items-center justify-center sm:justify-start gap-1 px-3 py-1 rounded-full ${isDarkMode ? "bg-gray-700 text-gray-300" : "bg-gray-50 text-gray-500"}`}
                  >
                    <Star
                      size={14}
    ...
    <div className="pt-24 pb-20 px-6 min-h-screen">
      <div className="container mx-auto relative">
        ...
        <div className="text-center mb-8 pt-8 md:pt-0">
          <h2
            className={`text-4xl font-serif font-bold ${isDarkMode ? "text-white" : "text-[#3D3D3D]"}`}
          >
            Our Gallery
          </h2>
          {activeService ? (
...
const StoreView = ({
  ...
  const sendInquiry = () => {
    ...
    window.open(
      `https://wa.me/916207413198?text=${encodeURIComponent(message)}`,
      "_blank",
    );
  };
    ...
    <div className="pt-24 pb-20 px-6 min-h-screen">
      <div className="container mx-auto relative">
          ...
          {isLoading
            ...
            : filteredProducts.map((product) => {
                ...
                return (
                  <div
                    key={product.id}
                    className={`rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 group flex flex-col h-full relative ${isDarkMode ? "bg-[#2A2A2A]" : "bg-white"}`}
                  >
                    <div
                      className={`h-48 overflow-hidden relative ${isDarkMode ? "bg-gray-800" : "bg-gray-100"}`}
                    >
                      <img
                        src={product.image}
                        alt={product.name}
                    ...
                    <div className="p-4 flex flex-col flex-grow">
                      ...
                      <h3
                        className={`font-bold text-lg mt-1 line-clamp-1 ${isDarkMode ? "text-white" : "text-[#3D3D3D]"}`}
                      >
                        {product.name}
                      </h3>
                      <div className="flex flex-col gap-2 mt-auto pt-4">
                        <div className="flex justify-between items-center">
                          ...
                          <span
                            className={`text-lg font-bold ${isOutOfStock ? "text-gray-500" : "text-[var(--theme-secondary)]"}`}
                          >
                            {product.price}
                          </span>
                        </div>
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            className={`text-white p-2 rounded-lg transition-colors shadow-sm flex items-center justify-center flex-1 ${isOutOfStock ? "bg-gray-400 cursor-not-allowed" : "bg-[var(--theme-primary)] hover:brightness-110"}`}
                          >
                            {isOutOfStock ? (
                              <Ban size={18} />
                            ) : (
        ...
        {isBagOpen && (
          ...
          >
            <div
              className={`rounded-t-2xl sm:rounded-2xl max-w-md w-full overflow-hidden shadow-2xl animate-fade-in-up ${isDarkMode ? "bg-[#2A2A2A] text-white" : "bg-white"}`}
              onClick={(e) => e.stopPropagation()}
            >
              <div className="bg-[#3D3D3D] text-white p-4 flex justify-between items-center">
                ...
                <button onClick={() => setIsBagOpen(false)}>
                  <X size={20} />
                </button>
              </div>
                ...
                {cart.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {cart.map((item, idx) => (
                      <div
                        key={idx}
                        className={`flex items-center justify-between p-3 rounded-lg border ${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-gray-50 border-gray-100"}`}
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p
                              className={`font-bold text-sm line-clamp-1 ${isDarkMode ? "text-white" : "text-gray-800"}`}
                            >
                              {item.name}
                            </p>
                            {/* Replaced price color */}
              ...
              <div
                className={`p-4 border-t ${isDarkMode ? "border-gray-700 bg-gray-800" : "border-gray-100 bg-gray-50"}`}
              >
                <Button
        ...
        {selectedProduct && (
          ...
          >
            <div
              className={`rounded-2xl max-w-lg w-full overflow-hidden shadow-2xl animate-fade-in-up ${isDarkMode ? "bg-[#2A2A2A]" : "bg-white"}`}
              onClick={(e) => e.stopPropagation()}
            >
              <div
                className={`relative h-64 md:h-72 ${isDarkMode ? "bg-gray-800" : "bg-gray-100"}`}
              >
                <img
              ...
              <div className="p-6 md:p-8">
                <h3
                  className={`text-2xl font-serif font-bold mb-2 ${isDarkMode ? "text-white" : "text-[#3D3D3D]"}`}
                >
                ...
                <p
                  className={`mb-6 text-sm md:text-base ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}
                >
...
const AdminView = ({
  ...
  const handleSaveService = async (e) => {
    e.preventDefault();
    /* ... same logic ... */ const form = e.target;
    const data = {
  ...
  const handleSaveProduct = async (e) => {
    ...
    if (file) {
      try {
        ...
        notify("Error saving product: " + e.message, "error");
      }
    } else {
      if (editingProduct) {
        const data = {
  ...
  if (!user)
    return (
      <div className="pt-32 pb-20 px-6 min-h-screen flex items-center justify-center">
        <div
          className={`p-8 rounded-2xl shadow-xl w-full max-w-md border ${isDarkMode ? "bg-[#2A2A2A] border-gray-700" : "bg-white border-gray-100"}`}
        >
          <h2
            className={`text-2xl font-serif font-bold mb-6 text-center ${isDarkMode ? "text-white" : "text-[#3D3D3D]"}`}
          >
            Admin Login
          </h2>
          <div className="space-y-4">
            <input
              ...
              className={`w-full p-3 border rounded-lg outline-none focus:ring-2 focus:ring-[var(--theme-primary)] ${isDarkMode ? "bg-gray-700 border-gray-600 text-white" : ""}`}
              value={adminEmail}
              onChange={(e) => {
  ...
  return (
    <div
      className={`pt-24 pb-20 px-4 md:px-6 min-h-screen ${isDarkMode ? "bg-[#121212]" : "bg-gray-50"}`}
    >
      <ConfirmationModal
      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-6 md:mb-8 gap-4 px-1">
          <h2
            className={`text-2xl md:text-3xl font-serif font-bold text-center md:text-left ${isDarkMode ? "text-white" : "text-[#3D3D3D]"}`}
          >
            Admin Dashboard
          </h2>
          <Button
        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-8">
          ...
          >
            <h3 className="text-xl font-bold mb-4 flex items-center gap-2">
              <Megaphone className="text-[var(--theme-secondary)]" />{" "}
              Announcement Banner
            </h3>
            <form
            ...
            >
              <input
                ...
                className={`flex-grow p-2.5 border rounded outline-none w-full ${isDarkMode ? "bg-gray-700 border-gray-600 text-white" : ""}`}
              />
          ...
          <div className={cardClass}>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={asset.field}
                  className={`p-4 rounded-xl border ${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-gray-50 border-gray-100"}`}
                >
          ...
          <div className={cardClass}>
            ...
            <div className="flex flex-wrap gap-2">
              {["Bridal", "Hair", "Skin"].map((cat) => (
                <span
                  key={cat}
                  className={`px-3 py-1 rounded-full text-xs font-medium border capitalize cursor-default opacity-70 flex items-center gap-1 ${isDarkMode ? "bg-gray-700 border-gray-600 text-gray-400" : "bg-gray-100 border-gray-200 text-gray-500"}`}
              ...
              {categoriesDocs.map((cat) => (
                <span
                  key={cat.id}
                  className={`pl-3 pr-1 py-1 rounded-full text-xs font-medium border capitalize flex items-center gap-1 ${isDarkMode ? "bg-gray-700 border-gray-600 text-gray-300" : "bg-gray-100 border-gray-200 text-gray-600"}`}
                >
                  {cat.name}
                  <button
          ...
          <div className={cardClass}>
            ...
            <div className="space-y-4 max-h-96 overflow-y-auto pr-2 custom-scrollbar">
              {messages.map((msg) => (
                <div
                  key={msg.id}
                  className={`border p-4 rounded-xl transition-all ${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-gray-50 border-gray-100"}`}
                >
          ...
          <div className={cardClass} id="service-form">
            ...
            <form
              ...
              className={`p-4 rounded-xl mb-6 border ${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-gray-50 border-gray-100"}`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {services.map((s) => (
                ...
                <div
                  key={s.id}
                  className={`flex items-start justify-between p-3 md:p-4 rounded-lg border group ${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-gray-50 border-gray-100"}`}
                >
          ...
          <div className={cardClass}>
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold flex items-center gap-2">
                <Camera className="text-[var(--theme-primary)]" /> Manage
                Gallery
              </h3>
              {editingGalleryItem && (
                <button
            ...
            <form
              ...
              className={`p-4 rounded-xl mb-6 border flex flex-col gap-3 ${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-gray-50 border-gray-100"} ${editingGalleryItem ? "ring-2 ring-[var(--theme-primary)]" : ""}`}
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
                <input
                  type="file"
                  className={`w-full p-2 rounded border text-sm ${isDarkMode ? "bg-gray-700 border-gray-600" : "bg-white"}`}
                />
                {editingGalleryItem && (
            ...
            <div
              className={`grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 max-h-96 overflow-y-auto p-2 rounded-lg border ${isDarkMode ? "border-gray-700 bg-gray-800/50" : "border-gray-200 bg-gray-50"}`}
              ...
              {gallery.length === 0 ? (
                ...
                gallery.map((img, index) => (
                  ...
                  >
                    <img
                      src={img.url}
                      className={`w-full h-full object-cover pointer-events-none ${img.isHidden ? "opacity-50 grayscale" : ""}`}
                      alt=""
                    />
                    ...
                    <div className="absolute inset-0 bg-black/60 flex items-center justify-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          handleToggleGallery(img.id, img.isHidden)
                        }
          ...
          <div className={cardClass} id="product-form">
            ...
            <div className="space-y-3 max-h-64 overflow-y-auto">
              {products.map((p) => (
                ...
                <div
                  key={p.id}
                  className={`flex justify-between items-center p-3 rounded-lg border ${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-gray-50 border-gray-100"} ${p.isHidden ? "opacity-60" : ""}`}
                >
...
export default function RadianceApp() {
  ...
  return (
    <div
      className={`min-h-screen font-sans transition-colors duration-300 relative ${isDarkMode ? "bg-[#121212] text-gray-100" : "bg-[#FDFBF7] text-gray-800"}`}
    >
      ...
      >
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          >
            ...
            <span
              className={`text-2xl font-serif font-bold tracking-tight ${isDarkMode ? "text-white" : "text-[#3D3D3D]"}`}
            >
              Radiance
            </span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button
              onClick={() => handleNav("home")}
              className={`font-medium transition-colors ${activeTab === "home" ? "text-[var(--theme-primary)]" : isDarkMode ? "text-gray-300 hover:text-[var(--theme-primary)]" : "text-gray-600 hover:text-[var(--theme-primary)]"}`}
            >
              Home
            </button>
            <button
              onClick={() => handleNav("home", "about")}
              className={`font-medium transition-colors ${isDarkMode ? "text-gray-300 hover:text-[var(--theme-primary)]" : "text-gray-600 hover:text-[var(--theme-primary)]"}`}
            >
              About Us
            </button>
            <button
              onClick={() => handleNav("gallery", null, "all")}
              className={`font-medium transition-colors ${activeTab === "gallery" ? "text-[var(--theme-primary)]" : isDarkMode ? "text-gray-300 hover:text-[var(--theme-primary)]" : "text-gray-600 hover:text-[var(--theme-primary)]"}`}
            >
              Gallery
            </button>
            <button
              onClick={() => handleNav("store")}
              className={`font-medium transition-colors ${activeTab === "store" ? "text-[var(--theme-primary)]" : isDarkMode ? "text-gray-300 hover:text-[var(--theme-primary)]" : "text-gray-600 hover:text-[var(--theme-primary)]"}`}
            >
              Product Store
            </button>
        ...
        {isMenuOpen && (
          <div
            className={`md:hidden border-t absolute w-full shadow-lg ${isDarkMode ? "bg-[#1A1A1A] border-gray-800" : "bg-white border-gray-100"}`}
          >
            <div className="flex flex-col p-6 space-y-4">
              <button
                ...
                className={`text-left font-medium ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}
              >
                Home
              </button>
              <button
                onClick={() => {
                  handleNav("home", "about");
                  setIsMenuOpen(false);
                }}
                className={`text-left font-medium ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}
              >
      ...
      {/* Footer */}
      <footer
        className={`py-8 md:py-12 border-t ${isDarkMode ? "bg-[#0A0A0A] border-gray-800" : "bg-[#2D2D2D] border-gray-700"} text-white`}
      >
        <div className="container mx-auto px-6 text-center">
          ...
          <button
            ...
            className="text-xs text-gray-600 hover:text-gray-400 flex items-center justify-center gap-1 mx-auto"
          >
            <User size={12} /> Login
          </button>
